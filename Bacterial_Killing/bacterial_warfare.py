...
if __name__ == '__main__':
	...
	parser.add_argument('--gridsize', type=int, help='gridsize')
	parser.add_argument('--n_steps', type=int, help='n_steps')
	parser.add_argument('--killing_rate', type=float, help='killing_rate')
	parser.add_argument('--reproduction_rate', type=float, help='reproduction_rate')
